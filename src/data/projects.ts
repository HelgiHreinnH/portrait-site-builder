...
export const projects: Record<string, ProjectData> = {
  "felles": {
    ...
    number: "01",
    client: "Felles",
    title: "Renovation Documentation Tool",
    subtitle: "A digital product that brings transparency and accountability to renovation projects — built from scratch",
    year: "2025–",
    outcome: "Product",
    ...
    phasesLed: ["Analyse", "Strategise", "Design", "Deliver"],
    brief: {
      challenge: "Renovation projects suffer from poor communication, lack of documentation, and zero transparency between architects, contractors, and homeowners. Updates get lost, progress is hard to track, and accountability is unclear.",
    ...
    approach: {
      ...
      methods: [
        { name: "Product Strategy", description: "Vision, roadmap, and feature prioritisation based on real renovation workflow needs." },
        { name: "UX Design", description: "Role-based views for architects, contractors, and homeowners — each seeing what matters to them." },
        { name: "Development", description: "Building the working application — iterating through real use on active renovation projects." },
      ],
    },
    insights: [
      ...
      { title: "30 Seconds Is Enough", description: "If an update takes longer than 30 seconds, contractors won't do it. Design for the constraint." },
      { title: "Transparency Creates Accountability", description: "Photo-based, timestamped updates build trust without requiring enforcement." },
    ],
    solution: {
      description: "A documentation and communication support tool that runs quietly in the background — creating transparency without demanding constant attention.",
      interventions: [
        { title: "Photo-Based Documentation", description: "Simple 30-second updates with photos — no complicated forms or data entry." },
        { title: "Real-Time Timeline", description: "Chronological overview of progress, updated hourly across all stakeholders." },
        { title: "Role-Based Views", description: "Architects, contractors, and homeowners each see what matters to them." },
      ],
    },
    impact: [
      { metric: "Status", value: "Active", description: "Ongoing product development" },
      { metric: "Update Time", value: "30s", description: "Average time to submit a progress update" },
      { metric: "Transparency", value: "100%", description: "All stakeholders see real-time progress" },
    ],
    gallery: [
      { src: `${FELLES_BUCKET}/felles%20landing%20page.png`, caption: "Landing page — introducing Felles as a renovation documentation tool" },
      { src: `${FELLES_BUCKET}/felles%20landing%20carousel.png`, caption: "Feature overview — photo-based documentation, timeline, and role-based views" },
      { src: `${FELLES_BUCKET}/Felle%20dashboard%20Fase%20tavle.png`, caption: "Dashboard — phase board view for tracking renovation milestones and tasks" },
      { src: `${FELLES_BUCKET}/Felles%20timeline%20dashboard.png`, caption: "Timeline dashboard — chronological overview of renovation progress and updates" },
    ],
  ...
  "archi-ar": {
    ...
    number: "03",
    client: "Archi AR",
    title: "Augmented Reality for Interior Design",
    subtitle: "A browser-based AR tool that lets interior designers overlay 3D models in real rooms — no app install, no VR headset, just share a link",
    year: "2024–",
    outcome: "Product",
    tags: ["Buildings", "Technology"],
    category: "B",
    ...
    phasesLed: ["Analyse", "Strategise", "Design", "Deliver"],
    brief: {
      challenge: "Interior designers struggle to communicate spatial proposals to clients. Renders are flat, physical mock-ups are expensive, and VR headsets create barriers. There's no simple way to show a design in the actual room it's meant for.",
      context: "An independent product built from scratch — applying the full method to a digital tool for design professionals. Built with Lovable and Supabase.",
    },
    approach: {
      title: "Full Product Development",
      description: "From identifying the communication gap to building a working product — the four-step method applied to AR technology.",
      methods: [
        { name: "Use Case Definition", description: "Interior designers presenting proposals in client spaces — from furniture to full room overlays." },
        { name: "AR Technology Research", description: "Browser-based WebAR for maximum accessibility — no app install required on iOS or Android." },
        { name: "Product Design & Development", description: "Dashboard, AR engine, marker system, and shareable link workflow — built end to end." },
      ],
    },
    insights: [
      { title: "Two Modes, Every Scenario", description: "Tabletop mode for scaled models on surfaces, Multi-Point mode for 1:1 room overlays with color-coded markers." },
      { title: "No App Install Is Everything", description: "The moment you ask a client to download an app, you lose them. Browser-based AR removes that barrier entirely." },
      { title: "Under Two Minutes", description: "From 3D file to shareable AR experience — the workflow had to be fast enough that designers actually use it." },
    ],
    solution: {
    ...
    impact: [
      { metric: "Status", value: "Active", description: "Live product — free to get started" },
      { metric: "Setup", value: "<2 min", description: "From 3D file to shareable AR experience" },
      { metric: "Compatibility", value: "iOS & Android", description: "Browser-based, no app install required" },
    ],
    gallery: [
      archiArImg,
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600",
