            ...
            {services.map((service, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative border border-border rounded-xl p-5 md:p-6 cursor-pointer transition-colors duration-300 bg-background hover:bg-muted/30 overflow-hidden flex flex-col items-center justify-start className="relative border border-border rounded-xl p-5 md:p-6 cursor-pointer transition-colors duration-300 bg-background hover:bg-muted/30 overflow-hidden flex flex-col items-center justify-start max-h-[560px]"
